 //用来获得option元素中selected属性为true的元素的id
        ...
        function Add_country(City_Selected_Id){
            ...
            $("#country").append("<option>Country</option>");
            //上面的清空与添加是为了保持级联的一致性
            var Province_Selected_ID = Get_Selected_Id("province");     
